...
interface EditAnnotationDialogProps {
    ...
    annotation: ClientUpdate;
    onAnnotationUpdated: () => void;
}

export function EditAnnotationDialog({ open, onOpenChange, annotation, onAnnotationUpdated }: EditAnnotationDialogProps) {
                         ...
                         <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        Tem certeza de que deseja salvar as alterações nesta anotação?
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
